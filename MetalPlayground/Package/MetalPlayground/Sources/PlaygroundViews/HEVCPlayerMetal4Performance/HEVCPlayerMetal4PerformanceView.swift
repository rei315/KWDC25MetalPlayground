...
import MetalKit
import SwiftUI
import HEVCPlayerMetal4Performance
import UniformTypeIdentifiers
import Shared

public struct HEVCPlayerMetal4PerformanceView: PlatformRepresentableController {
  public init() {}
#if os(macOS)
  public func makeNSViewController(context: Context) -> PlatformViewController {
    HEVCPlayerMetal4PerformanceViewController()
  }
...
public class HEVCPlayerMetal4PerformanceViewController: PlatformViewController {
  lazy var metalView: AlphaMetal4PerformanceVideoView = .init(device: MTLCreateSystemDefaultDevice()!)
  lazy var player: AlphaVideoMetal4PerformancePlayer = .init(renderTarget: metalView)
...
#if os(macOS)
extension HEVCPlayerMetal4PerformanceViewController {
...
#if os(iOS)
extension HEVCPlayerMetal4PerformanceViewController: UIDocumentPickerDelegate {
