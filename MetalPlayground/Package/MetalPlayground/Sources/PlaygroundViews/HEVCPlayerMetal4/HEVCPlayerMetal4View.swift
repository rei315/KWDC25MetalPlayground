...
import MetalKit
import SwiftUI
import HEVCPlayerMetal4
import UniformTypeIdentifiers
import Shared

public struct HEVCPlayerMetal4View: PlatformRepresentableController {
  public init() {}
#if os(macOS)
  public func makeNSViewController(context: Context) -> PlatformViewController {
    HEVCPlayerMetal4ViewController()
  }
...
public class HEVCPlayerMetal4ViewController: PlatformViewController {
  lazy var metalView: AlphaMetal4VideoView = .init(device: MTLCreateSystemDefaultDevice()!)
  lazy var player: AlphaVideoMetal4Player = .init(renderTarget: metalView)
...
#if os(macOS)
extension HEVCPlayerMetal4ViewController {
...
#if os(iOS)
extension HEVCPlayerMetal4ViewController: UIDocumentPickerDelegate {
